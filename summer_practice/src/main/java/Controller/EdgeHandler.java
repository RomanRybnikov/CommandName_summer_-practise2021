...
public class EdgeHandler implements ElementHandler{
            ...
            if(button== MouseEvent.BUTTON3 && !Controller.algoStart){
                ...
                itemDelete.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        controller.graph.deleteEdge(edgeVisualization.getVertex1().getVertexNum(),edgeVisualization.getVertex2().getVertexNum());
                        setChanges();
                    }
                });
                ...
                itemChange.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try{
                            ...
                            controller.graph.addEdge(new Edge(edgeVisualization.getVertex1().getVertexNum(),edgeVisualization.getVertex2().getVertexNum(),weight));
                            setChanges();
    ...
    private void setChanges(){
        ...
        for(Edge edge:controller.graph.getEdges()){
            ...
            int indexVertex1 = controller.graph.getVertexes().indexOf(vertex1);
            int indexVertex2 = controller.graph.getVertexes().indexOf(vertex2);
